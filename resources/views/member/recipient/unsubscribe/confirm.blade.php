...
<div class="container">
    <h2>シナリオ編集確認ページ</h2>
    <form method="POST" action="{{route('member.scenario.edit.execution')}}" class="edit"  enctype="multipart/form-data">
    @csrf
        ...
        <input type="hidden" name="scenario_id" value="{{ $inputData['scenario_id'] }}">
    </form>
</div>
@endsection